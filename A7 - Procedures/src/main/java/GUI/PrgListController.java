...
public class PrgListController implements Initializable {
    ...
    public void setUp(ObservableList<Controller> myData) {
        ...
        IStmt ex11 = new CompStmt(procedure1, new CompStmt(procedure2,
        ...
        for (int i = 0; i < 11; i++) {
            ...
            IProcTable<String, Pair<ArrayList<String>, IStmt>> procTable = new MyProcTable<>();
            exeStack.push(check.get(i));
            PrgState myPrgState = new PrgState(exeStack, symTableStack, out, check.get(i), fileTable, heap,procTable);
