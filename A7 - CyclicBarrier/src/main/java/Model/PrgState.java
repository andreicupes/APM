...
public class PrgState {
    ...
    private IBarrierTable<Integer, Pair<Integer, ArrayList<Integer>>> barrierTable;
    ...
    public PrgState(IStack<IStmt> _exestack, IDict<String, IValue> _symTable, IList<IValue> _out, IStmt _originalProgram, IDict<String, BufferedReader> _fileTable, IHeap<Integer, IValue> _heap,IBarrierTable<Integer, Pair<Integer, ArrayList<Integer>>> _barrierTable) {
        ...
        this.barrierTable = _barrierTable;
    ...
    public IBarrierTable<Integer, Pair<Integer, ArrayList<Integer>>> getBarrierTable() { return this.barrierTable; }
