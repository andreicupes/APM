...
public class MyBarrierTable<T1,T2> implements IBarrierTable<T1,T2>{
    ...
    @Override
    public IBarrierTable<T1, T2> deepCopy() {
        MyBarrierTable<T1, T2> BarrierTableCopy = new MyBarrierTable<T1, T2>();
        BarrierTableCopy.setContent(this.getContent());

        return BarrierTableCopy;
    }
}
