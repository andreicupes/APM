...
public class PrgListController implements Initializable {
    ...
    public void setUp(ObservableList<Controller> myData) {
        ...
        for (int i = 0; i < 11; i++) {
            ...
            ISemaphoreTable<Integer, Triplet<Integer, ArrayList<Integer>, Integer>> semaphoreTbl = new MySemaphoreTable<>();
            exeStack.push(check.get(i));
            PrgState myPrgState = new PrgState(exeStack, symTable, out, check.get(i), fileTable, heap,semaphoreTbl);
