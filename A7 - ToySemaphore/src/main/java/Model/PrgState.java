...
public class PrgState {
    ...
    private ISemaphoreTable<Integer, Triplet<Integer, ArrayList<Integer>, Integer>> toySemaphoreTable;
    ...
    public PrgState(IStack<IStmt> _exestack, IDict<String, IValue> _symTable, IList<IValue> _out, IStmt _originalProgram, IDict<String, BufferedReader> _fileTable, IHeap<Integer, IValue> _heap,ISemaphoreTable<Integer, Triplet<Integer, ArrayList<Integer>, Integer>> _semaphoreTable) {
        ...
        this.toySemaphoreTable=_semaphoreTable;
    ...
    public ISemaphoreTable<Integer, Triplet<Integer, ArrayList<Integer>, Integer>> getSemaphoreTable() { return this.toySemaphoreTable; }
