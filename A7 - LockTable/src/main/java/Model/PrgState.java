...
public class PrgState {
    ...
    public PrgState(IStack<IStmt> _exestack, IDict<String, IValue> _symTable, IList<IValue> _out, IStmt _originalProgram, IDict<String, BufferedReader> _fileTable, IHeap<Integer, IValue> _heap,ILockTable<Integer, Integer> _lock) {
